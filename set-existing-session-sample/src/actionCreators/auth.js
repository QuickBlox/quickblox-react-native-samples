...
export function sessionGet(payload) {
  return {payload, type: AUTH_GET_SESSION_REQUEST};
}
...
export function logoutRequest(payload) {
  return {payload, type: AUTH_LOGOUT_REQUEST};
}
...
export function startSessionWithToken(token) {
  return {payload: token, type: START_WITH_TOKEN};
}
